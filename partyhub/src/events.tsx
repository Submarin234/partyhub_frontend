...
const events: EventProps[] = [
    ...
    },
    {
        ...
        description: "Are you ready to light another memorable night?\n" +
            ...
            "🆃🅸🅲🅺🅴🆃🆂\n" +
            "Link: https://www.entertix.ro/…/world-of-noa-10-decembrie…\n" +
            "40 lei – Online (No wasted time)\n" +
            "Important details:\n" +
            "Free entry:\n" +
            "For ladies all night!\n" +
            "For people who take their reserved table before 10:00 p.m.!\n" +
    ...
    },
    {
        ...
        description: "See you on the dance floor la (H)ALL STARS NIGHT 😎!\n" +
            ...
            "⏰ Party-ul începe la ora 22:00\n" +
            "💥Dăm 400 de shot-uri gratuite până la 23:00💥\n" +
    ...
    },
    {
        ...
        description: "Despre eveniment\n" +
            ...
            "Intrare gratuită pentru fete și shoturi 1+1 gratis până la ora 00:00🥂🤩\n" +
            "Sâmbătă noaptea te așteptăm la cel mai consacrat și așteptat party al săptămânii ▶ Retro Revolution!!! 🥂🤩🎶🍹\n" +
    ...
    },
    {
        ...
        description: "If it’s FRIDAY – it’s a party!\n" +
            ...
            "MIRROR djs – Their rhythms will not let you sit down for a minute.\n" +
            "ARMONIA djs – Those who will warm up the Friday atmosphere and turn the evening into an unforgettable experience.\n" +
            "Dress code suggestion: The 80s-90s.\n" +
            "🆃🅸🅲🅺🅴🆃🆂\n" +
            "Link:\n" +
            "https://link.extasy.com/jUcgpqH0Rub\n" +
            "https://www.entertix.ro/…/armonia-disco-retro-25…\n" +
            "30 lei – Early bird\n" +
            "50 lei – At the door\n" +
            "❗️Important details:\n" +
            "Free entry:\n" +
            "For ladies who come before 11:00 p.m!\n" +
            "For people who take their reserved table before 10:00 p.m!\n" +
            "Rezervarea se realizează printr-un mesaj privat sau prin telefon la 0736 934 985!\n" +
            "🕙 Access – ora 09:00 p.m.\n" +
